module.exports = require('yargs').usage('Usage: $0 <command> [options]').command('preversion', 'To be run as part of your npm preversion script', function(yargs) {
  return yargs.epilog('Does the following:\n\n* Verifies head is <branch>\n* Verifies working folder is not dirty\n\nExit code is non-zero on error.').option('b', {
    alias: 'branch',
    demand: false,
    "default": 'master',
...
}).command('version', 'To be run as part of your npm version script', function(yargs) {
...
}).command('postversion', 'To be run as part of your npm postversion script', function(yargs) {
